...
import { ArrowUp, ArrowDown, KeyRound, ListChecks } from "lucide-react";
        ...
        <Table>
          ...
          <TableBody>
            {filteredAndSortedDipendenti.map((dipendente) => (
              <TableRow className="text-[16px] text-[#2e2e2e] cursor-pointer" onClick={() => handleEdit(dipendente)}>
